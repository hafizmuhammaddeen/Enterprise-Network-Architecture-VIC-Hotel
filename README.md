...
https://youtu.be/kqNd-6sJgEc?si=JKZCfVYCjbuKgyl-

## 📌 Executive Summary
This repository contains the complete design, simulation, and implementation of a secure, scalable, and highly efficient enterprise network for **VIC Modern Hotel**. Engineered using Cisco Packet Tracer, this project demonstrates advanced system architecture, logical network segmentation, dynamic routing, and robust security protocols across a multi-floor infrastructure.

As a System Architect, the primary objective was to bridge the gap between physical hardware and secure digital communication, ensuring seamless departmental isolation, centralized management, and high availability.

---

## 🎥 Network Simulation & Walkthrough
Watch the complete demonstration of OSPF routing, DHCP IP allocation, and Inter-VLAN communication in action:
...
A closer look at the VLAN segmentation and hardware deployment across different floors:
...
4. **Test Routing:** Ping a PC on the 1st Floor from the 3rd Floor to verify OSPF and Inter-VLAN routing.
...
---
*Architected and engineered by Hafiz Muhammad Deen.*
